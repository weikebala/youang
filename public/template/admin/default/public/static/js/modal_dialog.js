...
function $modal(data) {
    ...
    tipIconImg = '';
    if (data.icon === 'success') { tipIconImg = success_modal } else if (data.icon === 'warning') { tipIconImg = warning_modal } else if (data.icon === 'error') { tipIconImg = error_modal } else if (data.icon === 'question') { tipIconImg = question_modal } else { tipIconImg = info_modal }
    ...
    if (data.type === 'message') {
        ...
        $('#' + idText + '_box').append('<div class="' + idText + '_item item1 msg-icon"><img class="msg-icon" src="' + tipIconImg + '" /></div>');
        $('#' + idText + '_box').append('<div class="' + idText + '_item item2">' + data.content + '</div>');
        if (data.closable) { width_s += fontSize + 4;
        ...
        $('.' + idText + '_item msg-icon').css({ width: fontSize + 4 + 'px', verticalAlign: 'top', position: 'relative', top: '-12px' })
        ...
        var timers;
        if (!data.manual) { timers = setTimeout(close, data.timeout); }
        ...
        $('.' + idText + 'centerBox').css({ width: data.width + 'px', padding: '20px', background: '#ffffff', position: 'fixed', right: 0, left: 0, margin: 'auto', borderRadius: '5px', boxShadow: '0 1px 6px rgba(0,0,0,.2)', opacity: '0' })
        $('.' + idText + 'centerBox').append('<div class="' + idText + 'title"></div>')
        $('.' + idText + 'title').append('<div class="' + idText + '_item item1"><img class="msg-icon" src="' + tipIconImg + '" /></div>');
        $('.' + idText + 'title').append('<div class="' + idText + '_item item2">' + data.title + '</div>');
        if (data.closable) { $('.' + idText + 'title').append('<div class="' + idText + '_item item3"><img src="' + close_modal + '" /></div>'); }
        ...
        $('.' + idText + 'centerBox').css({ top: data.top + 40, })
        $('.' + idText + 'centerBox').animate({ 'top': data.top, 'opacity': '1', }, data.transition);
        $('.button_s_model').hover(function() { $(this).css({ 'opacity': '.8' }) }, function() { $(this).css({ 'opacity': '1' }) })
